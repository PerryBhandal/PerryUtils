...
alias init_env3="virtualenv -p /usr/bin/python3.5 venv; activate; pip3 install flake8; pip3 install git+git://github.com/JukkaL/mypy.git ; pip3 install -r requirements/dev.txt; ./init_env.sh 2> /dev/null"
