...
alias init_env3="virtualenv -p /usr/bin/python3 venv; activate; pip3 install flake8; pip3 install git+git://github.com/JukkaL/mypy.git ; pip3 install pip3 install -r requirements/dev.txt"
