...
alias init_env3="virtualenv -p /usr/bin/python3 venv; activate; pip3 install flake8; pip3 install git+git://github.com/JukkaL/mypy.git ; pip3 install -r requirements/dev.txt"
...
alias bs="source /home/perry/.bashrc; rm -f /tmp/cur_shot.png; gnome-screenshot -a -f /tmp/cur_shot.png; xclip -i -selection c -t image/png /tmp/cur_shot.png"
